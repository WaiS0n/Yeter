...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'cc -pthread -shared -L/usr/local/lib -Wl,-rpath,/usr/local/lib '
              '-fstack-protector-strong',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'amd64-portbld-freebsd14.1',
 'BYTESTR_DEPS': '\\',
 'CC': 'cc -pthread',
 'CCSHARED': '-fPIC',
 ...
 'CONFIG_ARGS': "'--enable-shared' '--without-ensurepip' '--with-system-ffi' "
                ...
                "'--build=amd64-portbld-freebsd14.1' "
                "'build_alias=amd64-portbld-freebsd14.1' 'PKG_CONFIG=pkgconf' "
                "'PKG_CONFIG_LIBDIR=/usr/obj/usr/ports/lang/python311/work/.pkgconfig:/usr/local/libdata/pkgconfig:/usr/local/share/pkgconfig:/usr/libdata/pkgconfig' "
                "'CC=cc' 'CFLAGS=-O2 -pipe  -fstack-protector-strong "
                "-fno-strict-aliasing ' 'LDFLAGS= -L/usr/local/lib "
                "-Wl,-rpath,/usr/local/lib -fstack-protector-strong ' 'LIBS=' "
                "'CPPFLAGS=-I/usr/local/include' 'CPP=cpp'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/usr/obj/usr/ports/lang/python311/work/Python-3.11.9/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/usr/obj/usr/ports/lang/python311/work/Python-3.11.9/lcov-report',
 ...
 'HAVE__GETPTY': 0,
 'HOSTRUNNER': '',
 'HOST_GNU_TYPE': 'amd64-portbld-freebsd14.1',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'cc -pthread -shared -L/usr/local/lib -Wl,-rpath,/usr/local/lib '
             '-fstack-protector-strong',
 'LDVERSION': '3.11',
 'LIBC': '',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -O2 -pipe  '
                   ...
                   '-fPIC -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/usr/local/lib -Wl,-rpath,/usr/local/lib '
                    '-fstack-protector-strong -flto',
 'PY_CPPFLAGS': '-I. -I./Include -I/usr/local/include',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/usr/local/lib -Wl,-rpath,/usr/local/lib '
               '-fstack-protector-strong',
 'PY_LDFLAGS_NODIST': '-flto',
 'PY_LDFLAGS_NOLTO': '-L/usr/local/lib -Wl,-rpath,/usr/local/lib '
                     '-fstack-protector-strong -flto=thin',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/usr/obj/usr/ports/lang/python311/work/Python-3.11.9',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/usr/obj/usr/ports/lang/python311/work/Python-3.11.9 '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/usr/obj/usr/ports/lang/python311/work/Python-3.11.9 '
 ...
 'abs_builddir': '/usr/obj/usr/ports/lang/python311/work/Python-3.11.9',
 'abs_srcdir': '/usr/obj/usr/ports/lang/python311/work/Python-3.11.9',
