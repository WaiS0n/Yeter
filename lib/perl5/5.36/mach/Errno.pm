...
"amd64-freebsd-thread-multi-14.1-release-p2" or
	die "Errno architecture (amd64-freebsd-thread-multi-14.1-release-p2) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
