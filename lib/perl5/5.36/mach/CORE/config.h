...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Wed Nov 29 16:10:26 UTC 2023
 * Configured by     : mat
 * Target system     : freebsd buildervm 14.1-release-p2 freebsd 14.1-release releng14.1-n267679-10e31f0946d8 generic amd64 
 */
 ...
 */
#define ARCHLIB "/usr/local/lib/perl5/5.36/mach"		/**/
#define ARCHLIB_EXP "/usr/local/lib/perl5/5.36/mach"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/perl5/site_perl/mach/5.36"		/**/
#define SITEARCH_EXP "/usr/local/lib/perl5/site_perl/mach/5.36"		/**/
