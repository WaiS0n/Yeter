...
unless(defined(&_PATHS_H_)) {
    ...
    eval 'sub _PATH_LOCALBASE () {"/usr/local";}' unless defined(&_PATH_LOCALBASE);
    eval 'sub _PATH_DEFPATH () {"/sbin:/bin:/usr/sbin:/usr/bin:"  &_PATH_LOCALBASE "/sbin:"  &_PATH_LOCALBASE "/bin";}' unless defined(&_PATH_DEFPATH);
    ...
    eval 'sub _PATH_FIRMWARE () {"/usr/share/firmware";}' unless defined(&_PATH_FIRMWARE);
	...
	eval 'sub _PATH_I18NMODULE () {"/usr/lib"  &COMPAT_libcompat "/i18n";}' unless defined(&_PATH_I18NMODULE);
    } else {
    ...
    eval 'sub _PATH_DEVVMM () {"/dev/vmm/";}' unless defined(&_PATH_DEVVMM);
	...
	eval 'sub _PATH_DEFPATH () {"/rescue:/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin";}' unless defined(&_PATH_DEFPATH);
