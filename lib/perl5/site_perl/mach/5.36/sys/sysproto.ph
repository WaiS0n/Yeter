...
unless(defined(&_SYS_SYSPROTO_H_)) {
    ...
    eval 'sub PAD_ {
        my($t) = @_;
	    eval q(($sizeof{ &syscallarg_t} <= $sizeof{$t} ? 0: $sizeof{ &syscallarg_t} - $sizeof{$t}));
    }' unless defined(&PAD_);
    ...
    eval 'sub SYS_AUE_read () { &AUE_READ;}' unless defined(&SYS_AUE_read);
    eval 'sub SYS_AUE_write () { &AUE_WRITE;}' unless defined(&SYS_AUE_write);
    ...
    eval 'sub SYS_AUE_freebsd11_mknod () { &AUE_MKNOD;}' unless defined(&SYS_AUE_freebsd11_mknod);
    ...
    eval 'sub SYS_AUE_freebsd10_pipe () { &AUE_PIPE;}' unless defined(&SYS_AUE_freebsd10_pipe);
    ...
    eval 'sub SYS_AUE_freebsd11_vadvise () { &AUE_O_VADVISE;}' unless defined(&SYS_AUE_freebsd11_vadvise);
    ...
    eval 'sub SYS_AUE_setfib () { &AUE_SETFIB;}' unless defined(&SYS_AUE_setfib);
    ...
    eval 'sub SYS_AUE_freebsd11_stat () { &AUE_STAT;}' unless defined(&SYS_AUE_freebsd11_stat);
    eval 'sub SYS_AUE_freebsd11_fstat () { &AUE_FSTAT;}' unless defined(&SYS_AUE_freebsd11_fstat);
    eval 'sub SYS_AUE_freebsd11_lstat () { &AUE_LSTAT;}' unless defined(&SYS_AUE_freebsd11_lstat);
    ...
    eval 'sub SYS_AUE_freebsd11_getdirentries () { &AUE_GETDIRENTRIES;}' unless defined(&SYS_AUE_freebsd11_getdirentries);
    ...
    eval 'sub SYS_AUE_clock_nanosleep () { &AUE_NULL;}' unless defined(&SYS_AUE_clock_nanosleep);
    ...
    eval 'sub SYS_AUE_aio_read () { &AUE_AIO_READ;}' unless defined(&SYS_AUE_aio_read);
    eval 'sub SYS_AUE_aio_write () { &AUE_AIO_WRITE;}' unless defined(&SYS_AUE_aio_write);
    eval 'sub SYS_AUE_lio_listio () { &AUE_LIO_LISTIO;}' unless defined(&SYS_AUE_lio_listio);
    eval 'sub SYS_AUE_freebsd11_getdents () { &AUE_O_GETDENTS;}' unless defined(&SYS_AUE_freebsd11_getdents);
    ...
    eval 'sub SYS_AUE_freebsd11_nstat () { &AUE_STAT;}' unless defined(&SYS_AUE_freebsd11_nstat);
    eval 'sub SYS_AUE_freebsd11_nfstat () { &AUE_FSTAT;}' unless defined(&SYS_AUE_freebsd11_nfstat);
    eval 'sub SYS_AUE_freebsd11_nlstat () { &AUE_LSTAT;}' unless defined(&SYS_AUE_freebsd11_nlstat);
    ...
    eval 'sub SYS_AUE_freebsd11_fhstat () { &AUE_FHSTAT;}' unless defined(&SYS_AUE_freebsd11_fhstat);
    ...
    eval 'sub SYS_AUE_aio_return () { &AUE_AIO_RETURN;}' unless defined(&SYS_AUE_aio_return);
    eval 'sub SYS_AUE_aio_suspend () { &AUE_AIO_SUSPEND;}' unless defined(&SYS_AUE_aio_suspend);
    eval 'sub SYS_AUE_aio_cancel () { &AUE_AIO_CANCEL;}' unless defined(&SYS_AUE_aio_cancel);
    eval 'sub SYS_AUE_aio_error () { &AUE_AIO_ERROR;}' unless defined(&SYS_AUE_aio_error);
    eval 'sub SYS_AUE_freebsd6_aio_read () { &AUE_AIO_READ;}' unless defined(&SYS_AUE_freebsd6_aio_read);
    eval 'sub SYS_AUE_freebsd6_aio_write () { &AUE_AIO_WRITE;}' unless defined(&SYS_AUE_freebsd6_aio_write);
    eval 'sub SYS_AUE_freebsd6_lio_listio () { &AUE_LIO_LISTIO;}' unless defined(&SYS_AUE_freebsd6_lio_listio);
    ...
    eval 'sub SYS_AUE___acl_get_file () { &AUE_ACL_GET_FILE;}' unless defined(&SYS_AUE___acl_get_file);
    eval 'sub SYS_AUE___acl_set_file () { &AUE_ACL_SET_FILE;}' unless defined(&SYS_AUE___acl_set_file);
    eval 'sub SYS_AUE___acl_get_fd () { &AUE_ACL_GET_FD;}' unless defined(&SYS_AUE___acl_get_fd);
    eval 'sub SYS_AUE___acl_set_fd () { &AUE_ACL_SET_FD;}' unless defined(&SYS_AUE___acl_set_fd);
    eval 'sub SYS_AUE___acl_delete_file () { &AUE_ACL_DELETE_FILE;}' unless defined(&SYS_AUE___acl_delete_file);
    eval 'sub SYS_AUE___acl_delete_fd () { &AUE_ACL_DELETE_FD;}' unless defined(&SYS_AUE___acl_delete_fd);
    eval 'sub SYS_AUE___acl_aclcheck_file () { &AUE_ACL_CHECK_FILE;}' unless defined(&SYS_AUE___acl_aclcheck_file);
    eval 'sub SYS_AUE___acl_aclcheck_fd () { &AUE_ACL_CHECK_FD;}' unless defined(&SYS_AUE___acl_aclcheck_fd);
    ...
    eval 'sub SYS_AUE_aio_waitcomplete () { &AUE_AIO_WAITCOMPLETE;}' unless defined(&SYS_AUE_aio_waitcomplete);
    ...
    eval 'sub SYS_AUE_freebsd11_kevent () { &AUE_KEVENT;}' unless defined(&SYS_AUE_freebsd11_kevent);
    ...
    eval 'sub SYS_AUE___setugid () { &AUE_SETUGID;}' unless defined(&SYS_AUE___setugid);
    ...
    eval 'sub SYS_AUE_freebsd11_getfsstat () { &AUE_GETFSSTAT;}' unless defined(&SYS_AUE_freebsd11_getfsstat);
    eval 'sub SYS_AUE_freebsd11_statfs () { &AUE_STATFS;}' unless defined(&SYS_AUE_freebsd11_statfs);
    eval 'sub SYS_AUE_freebsd11_fstatfs () { &AUE_FSTATFS;}' unless defined(&SYS_AUE_freebsd11_fstatfs);
    eval 'sub SYS_AUE_freebsd11_fhstatfs () { &AUE_FHSTATFS;}' unless defined(&SYS_AUE_freebsd11_fhstatfs);
    eval 'sub SYS_AUE_ksem_close () { &AUE_SEMCLOSE;}' unless defined(&SYS_AUE_ksem_close);
    eval 'sub SYS_AUE_ksem_post () { &AUE_SEMPOST;}' unless defined(&SYS_AUE_ksem_post);
    eval 'sub SYS_AUE_ksem_wait () { &AUE_SEMWAIT;}' unless defined(&SYS_AUE_ksem_wait);
    eval 'sub SYS_AUE_ksem_trywait () { &AUE_SEMTRYWAIT;}' unless defined(&SYS_AUE_ksem_trywait);
    eval 'sub SYS_AUE_ksem_init () { &AUE_SEMINIT;}' unless defined(&SYS_AUE_ksem_init);
    eval 'sub SYS_AUE_ksem_open () { &AUE_SEMOPEN;}' unless defined(&SYS_AUE_ksem_open);
    eval 'sub SYS_AUE_ksem_unlink () { &AUE_SEMUNLINK;}' unless defined(&SYS_AUE_ksem_unlink);
    eval 'sub SYS_AUE_ksem_getvalue () { &AUE_SEMGETVALUE;}' unless defined(&SYS_AUE_ksem_getvalue);
    eval 'sub SYS_AUE_ksem_destroy () { &AUE_SEMDESTROY;}' unless defined(&SYS_AUE_ksem_destroy);
    ...
    eval 'sub SYS_AUE_freebsd13_swapoff () { &AUE_SWAPOFF;}' unless defined(&SYS_AUE_freebsd13_swapoff);
    eval 'sub SYS_AUE___acl_get_link () { &AUE_ACL_GET_LINK;}' unless defined(&SYS_AUE___acl_get_link);
    eval 'sub SYS_AUE___acl_set_link () { &AUE_ACL_SET_LINK;}' unless defined(&SYS_AUE___acl_set_link);
    eval 'sub SYS_AUE___acl_delete_link () { &AUE_ACL_DELETE_LINK;}' unless defined(&SYS_AUE___acl_delete_link);
    eval 'sub SYS_AUE___acl_aclcheck_link () { &AUE_ACL_CHECK_LINK;}' unless defined(&SYS_AUE___acl_aclcheck_link);
    eval 'sub SYS_AUE_sigwait () { &AUE_SIGWAIT;}' unless defined(&SYS_AUE_sigwait);
    eval 'sub SYS_AUE_thr_create () { &AUE_THR_CREATE;}' unless defined(&SYS_AUE_thr_create);
    eval 'sub SYS_AUE_thr_exit () { &AUE_THR_EXIT;}' unless defined(&SYS_AUE_thr_exit);
    eval 'sub SYS_AUE_thr_self () { &AUE_NULL;}' unless defined(&SYS_AUE_thr_self);
    eval 'sub SYS_AUE_thr_kill () { &AUE_THR_KILL;}' unless defined(&SYS_AUE_thr_kill);
    eval 'sub SYS_AUE_freebsd10__umtx_lock () { &AUE_NULL;}' unless defined(&SYS_AUE_freebsd10__umtx_lock);
    eval 'sub SYS_AUE_freebsd10__umtx_unlock () { &AUE_NULL;}' unless defined(&SYS_AUE_freebsd10__umtx_unlock);
    eval 'sub SYS_AUE_jail_attach () { &AUE_JAIL_ATTACH;}' unless defined(&SYS_AUE_jail_attach);
    ...
    eval 'sub SYS_AUE_ksem_timedwait () { &AUE_SEMWAIT;}' unless defined(&SYS_AUE_ksem_timedwait);
    ...
    eval 'sub SYS_AUE_thr_new () { &AUE_THR_NEW;}' unless defined(&SYS_AUE_thr_new);
    eval 'sub SYS_AUE_sigqueue () { &AUE_NULL;}' unless defined(&SYS_AUE_sigqueue);
    eval 'sub SYS_AUE_kmq_open () { &AUE_MQ_OPEN;}' unless defined(&SYS_AUE_kmq_open);
    eval 'sub SYS_AUE_kmq_setattr () { &AUE_MQ_SETATTR;}' unless defined(&SYS_AUE_kmq_setattr);
    eval 'sub SYS_AUE_kmq_timedreceive () { &AUE_MQ_TIMEDRECEIVE;}' unless defined(&SYS_AUE_kmq_timedreceive);
    eval 'sub SYS_AUE_kmq_timedsend () { &AUE_MQ_TIMEDSEND;}' unless defined(&SYS_AUE_kmq_timedsend);
    eval 'sub SYS_AUE_kmq_notify () { &AUE_MQ_NOTIFY;}' unless defined(&SYS_AUE_kmq_notify);
    eval 'sub SYS_AUE_kmq_unlink () { &AUE_MQ_UNLINK;}' unless defined(&SYS_AUE_kmq_unlink);
    ...
    eval 'sub SYS_AUE_aio_fsync () { &AUE_AIO_FSYNC;}' unless defined(&SYS_AUE_aio_fsync);
    eval 'sub SYS_AUE_rtprio_thread () { &AUE_RTPRIO;}' unless defined(&SYS_AUE_rtprio_thread);
    eval 'sub SYS_AUE_sctp_peeloff () { &AUE_SCTP_PEELOFF;}' unless defined(&SYS_AUE_sctp_peeloff);
    eval 'sub SYS_AUE_sctp_generic_sendmsg () { &AUE_SCTP_GENERIC_SENDMSG;}' unless defined(&SYS_AUE_sctp_generic_sendmsg);
    eval 'sub SYS_AUE_sctp_generic_sendmsg_iov () { &AUE_SCTP_GENERIC_SENDMSG_IOV;}' unless defined(&SYS_AUE_sctp_generic_sendmsg_iov);
    eval 'sub SYS_AUE_sctp_generic_recvmsg () { &AUE_SCTP_GENERIC_RECVMSG;}' unless defined(&SYS_AUE_sctp_generic_recvmsg);
    ...
    eval 'sub SYS_AUE_thr_kill2 () { &AUE_THR_KILL2;}' unless defined(&SYS_AUE_thr_kill2);
    eval 'sub SYS_AUE_freebsd12_shm_open () { &AUE_SHMOPEN;}' unless defined(&SYS_AUE_freebsd12_shm_open);
    ...
    eval 'sub SYS_AUE_freebsd11_fstatat () { &AUE_FSTATAT;}' unless defined(&SYS_AUE_freebsd11_fstatat);
    ...
    eval 'sub SYS_AUE_freebsd11_mknodat () { &AUE_MKNODAT;}' unless defined(&SYS_AUE_freebsd11_mknodat);
    ...
    eval 'sub SYS_AUE_jail_get () { &AUE_JAIL_GET;}' unless defined(&SYS_AUE_jail_get);
    eval 'sub SYS_AUE_jail_set () { &AUE_JAIL_SET;}' unless defined(&SYS_AUE_jail_set);
    eval 'sub SYS_AUE_jail_remove () { &AUE_JAIL_REMOVE;}' unless defined(&SYS_AUE_jail_remove);
    eval 'sub SYS_AUE_freebsd12_closefrom () { &AUE_CLOSEFROM;}' unless defined(&SYS_AUE_freebsd12_closefrom);
    ...
    eval 'sub SYS_AUE_getloginclass () { &AUE_GETLOGINCLASS;}' unless defined(&SYS_AUE_getloginclass);
    eval 'sub SYS_AUE_setloginclass () { &AUE_SETLOGINCLASS;}' unless defined(&SYS_AUE_setloginclass);
    ...
    eval 'sub SYS_AUE_posix_fallocate () { &AUE_POSIX_FALLOCATE;}' unless defined(&SYS_AUE_posix_fallocate);
    eval 'sub SYS_AUE_posix_fadvise () { &AUE_POSIX_FADVISE;}' unless defined(&SYS_AUE_posix_fadvise);
    ...
    eval 'sub SYS_AUE_aio_mlock () { &AUE_AIO_MLOCK;}' unless defined(&SYS_AUE_aio_mlock);
    eval 'sub SYS_AUE_procctl () { &AUE_PROCCTL;}' unless defined(&SYS_AUE_procctl);
    eval 'sub SYS_AUE_ppoll () { &AUE_POLL;}' unless defined(&SYS_AUE_ppoll);
    eval 'sub SYS_AUE_futimens () { &AUE_FUTIMES;}' unless defined(&SYS_AUE_futimens);
    eval 'sub SYS_AUE_utimensat () { &AUE_FUTIMESAT;}' unless defined(&SYS_AUE_utimensat);
    eval 'sub SYS_AUE_fdatasync () { &AUE_FSYNC;}' unless defined(&SYS_AUE_fdatasync);
    ...
    eval 'sub SYS_AUE_kevent () { &AUE_KEVENT;}' unless defined(&SYS_AUE_kevent);
    eval 'sub SYS_AUE_cpuset_getdomain () { &AUE_NULL;}' unless defined(&SYS_AUE_cpuset_getdomain);
    eval 'sub SYS_AUE_cpuset_setdomain () { &AUE_NULL;}' unless defined(&SYS_AUE_cpuset_setdomain);
    eval 'sub SYS_AUE_getrandom () { &AUE_NULL;}' unless defined(&SYS_AUE_getrandom);
    eval 'sub SYS_AUE_getfhat () { &AUE_NULL;}' unless defined(&SYS_AUE_getfhat);
    eval 'sub SYS_AUE_fhlink () { &AUE_NULL;}' unless defined(&SYS_AUE_fhlink);
    eval 'sub SYS_AUE_fhlinkat () { &AUE_NULL;}' unless defined(&SYS_AUE_fhlinkat);
    eval 'sub SYS_AUE_fhreadlink () { &AUE_NULL;}' unless defined(&SYS_AUE_fhreadlink);
    eval 'sub SYS_AUE_funlinkat () { &AUE_UNLINKAT;}' unless defined(&SYS_AUE_funlinkat);
    eval 'sub SYS_AUE_copy_file_range () { &AUE_NULL;}' unless defined(&SYS_AUE_copy_file_range);
    eval 'sub SYS_AUE___sysctlbyname () { &AUE_SYSCTL;}' unless defined(&SYS_AUE___sysctlbyname);
    eval 'sub SYS_AUE_shm_open2 () { &AUE_SHMOPEN;}' unless defined(&SYS_AUE_shm_open2);
    eval 'sub SYS_AUE_shm_rename () { &AUE_SHMRENAME;}' unless defined(&SYS_AUE_shm_rename);
    eval 'sub SYS_AUE_sigfastblock () { &AUE_NULL;}' unless defined(&SYS_AUE_sigfastblock);
    eval 'sub SYS_AUE___realpathat () { &AUE_REALPATHAT;}' unless defined(&SYS_AUE___realpathat);
    eval 'sub SYS_AUE_close_range () { &AUE_CLOSERANGE;}' unless defined(&SYS_AUE_close_range);
    eval 'sub SYS_AUE_rpctls_syscall () { &AUE_NULL;}' unless defined(&SYS_AUE_rpctls_syscall);
    eval 'sub SYS_AUE___specialfd () { &AUE_SPECIALFD;}' unless defined(&SYS_AUE___specialfd);
    eval 'sub SYS_AUE_aio_writev () { &AUE_AIO_WRITEV;}' unless defined(&SYS_AUE_aio_writev);
    eval 'sub SYS_AUE_aio_readv () { &AUE_AIO_READV;}' unless defined(&SYS_AUE_aio_readv);
    eval 'sub SYS_AUE_fspacectl () { &AUE_FSPACECTL;}' unless defined(&SYS_AUE_fspacectl);
    eval 'sub SYS_AUE_sched_getcpu () { &AUE_NULL;}' unless defined(&SYS_AUE_sched_getcpu);
    eval 'sub SYS_AUE_swapoff () { &AUE_SWAPOFF;}' unless defined(&SYS_AUE_swapoff);
    eval 'sub SYS_AUE_kqueuex () { &AUE_KQUEUE;}' unless defined(&SYS_AUE_kqueuex);
    eval 'sub SYS_AUE_membarrier () { &AUE_NULL;}' unless defined(&SYS_AUE_membarrier);
    eval 'sub SYS_AUE_timerfd_create () { &AUE_TIMERFD;}' unless defined(&SYS_AUE_timerfd_create);
    eval 'sub SYS_AUE_timerfd_gettime () { &AUE_TIMERFD;}' unless defined(&SYS_AUE_timerfd_gettime);
    eval 'sub SYS_AUE_timerfd_settime () { &AUE_TIMERFD;}' unless defined(&SYS_AUE_timerfd_settime);
    eval 'sub SYS_AUE_kcmp () { &AUE_NULL;}' unless defined(&SYS_AUE_kcmp);
