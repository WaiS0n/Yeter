...
unless(defined(&_SYS_FBIO_H_)) {
    ...
    eval 'sub FBTYPE_EFIFB () {31;}' unless defined(&FBTYPE_EFIFB);
    eval 'sub FBTYPE_LASTPLUSONE () {32;}' unless defined(&FBTYPE_LASTPLUSONE);
	...
	eval 'sub FB_FLAG_NOWRITE () {2;}' unless defined(&FB_FLAG_NOWRITE);
	eval 'sub FB_FLAG_MEMATTR () {4;}' unless defined(&FB_FLAG_MEMATTR);
    ...
    eval 'sub V_INFO_CWIDTH9 () {(1<< 5);}' unless defined(&V_INFO_CWIDTH9);
    ...
    eval 'sub V_ADP_CWIDTH9 () {(1<< 21);}' unless defined(&V_ADP_CWIDTH9);
    ...
    eval 'sub FBIO_GETRGBOFFS () { &_IOR(ord(\'F\'), 116, \'struct fb_rgboffs\');}' unless defined(&FBIO_GETRGBOFFS);
}
1;
