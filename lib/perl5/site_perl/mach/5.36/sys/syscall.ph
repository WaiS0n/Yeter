...
eval 'sub SYS_freebsd13_swapoff () {424;}' unless defined(&SYS_freebsd13_swapoff);
...
eval 'sub SYS_freebsd10__umtx_lock () {434;}' unless defined(&SYS_freebsd10__umtx_lock);
eval 'sub SYS_freebsd10__umtx_unlock () {435;}' unless defined(&SYS_freebsd10__umtx_unlock);
...
eval 'sub SYS_fspacectl () {580;}' unless defined(&SYS_fspacectl);
eval 'sub SYS_sched_getcpu () {581;}' unless defined(&SYS_sched_getcpu);
eval 'sub SYS_swapoff () {582;}' unless defined(&SYS_swapoff);
eval 'sub SYS_kqueuex () {583;}' unless defined(&SYS_kqueuex);
eval 'sub SYS_membarrier () {584;}' unless defined(&SYS_membarrier);
eval 'sub SYS_timerfd_create () {585;}' unless defined(&SYS_timerfd_create);
eval 'sub SYS_timerfd_gettime () {586;}' unless defined(&SYS_timerfd_gettime);
eval 'sub SYS_timerfd_settime () {587;}' unless defined(&SYS_timerfd_settime);
eval 'sub SYS_kcmp () {588;}' unless defined(&SYS_kcmp);
eval 'sub SYS_MAXSYSCALL () {589;}' unless defined(&SYS_MAXSYSCALL);
1;
