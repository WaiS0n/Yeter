...
unless(defined(&_SYS_ELF_COMMON_H_)) {
    ...
    eval 'sub DT_RELRSZ () {35;}' unless defined(&DT_RELRSZ);
    eval 'sub DT_RELR () {36;}' unless defined(&DT_RELR);
    eval 'sub DT_RELRENT () {37;}' unless defined(&DT_RELRENT);
    ...
    eval 'sub DT_AARCH64_BTI_PLT () {0x70000001;}' unless defined(&DT_AARCH64_BTI_PLT);
    eval 'sub DT_AARCH64_PAC_PLT () {0x70000003;}' unless defined(&DT_AARCH64_PAC_PLT);
    eval 'sub DT_AARCH64_VARIANT_PCS () {0x70000005;}' unless defined(&DT_AARCH64_VARIANT_PCS);
    ...
    eval 'sub NT_X86_SEGBASES () {0x200;}' unless defined(&NT_X86_SEGBASES);
    ...
    eval 'sub NT_ARM_ADDR_MASK () {0x406;}' unless defined(&NT_ARM_ADDR_MASK);
    ...
    eval 'sub GNU_PROPERTY_AARCH64_FEATURE_1_BTI () {0x1;}' unless defined(&GNU_PROPERTY_AARCH64_FEATURE_1_BTI);
    eval 'sub GNU_PROPERTY_AARCH64_FEATURE_1_PAC () {0x2;}' unless defined(&GNU_PROPERTY_AARCH64_FEATURE_1_PAC);
    ...
    eval 'sub ELFCOMPRESS_ZSTD () {2;}' unless defined(&ELFCOMPRESS_ZSTD);
    ...
    eval 'sub AT_KPRELOAD () {34;}' unless defined(&AT_KPRELOAD);
    eval 'sub AT_USRSTACKBASE () {35;}' unless defined(&AT_USRSTACKBASE);
    eval 'sub AT_USRSTACKLIM () {36;}' unless defined(&AT_USRSTACKLIM);
    eval 'sub AT_COUNT () {37;}' unless defined(&AT_COUNT);
    ...
    eval 'sub ELF_BSDF_VMNOOVERCOMMIT () {0x2;}' unless defined(&ELF_BSDF_VMNOOVERCOMMIT);
}
1;
