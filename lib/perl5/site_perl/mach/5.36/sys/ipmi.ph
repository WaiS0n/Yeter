...
unless(defined(&__SYS_IPMI_H__)) {
    ...
    eval 'sub IPMI_IPMB_CHANNEL () {0x;}' unless defined(&IPMI_IPMB_CHANNEL);
    ...
    eval 'sub IPMI_CHASSIS_REQUEST () {0x;}' unless defined(&IPMI_CHASSIS_REQUEST);
    eval 'sub IPMI_CHASSIS_CONTROL () {0x2;}' unless defined(&IPMI_CHASSIS_CONTROL);
    eval 'sub IPMI_CC_POWER_DOWN () {0x;}' unless defined(&IPMI_CC_POWER_DOWN);
    eval 'sub IPMI_CC_POWER_UP () {0x1;}' unless defined(&IPMI_CC_POWER_UP);
    eval 'sub IPMI_CC_POWER_CYCLE () {0x2;}' unless defined(&IPMI_CC_POWER_CYCLE);
    eval 'sub IPMI_CC_HARD_RESET () {0x3;}' unless defined(&IPMI_CC_HARD_RESET);
    eval 'sub IPMI_CC_PULSE_DI () {0x4;}' unless defined(&IPMI_CC_PULSE_DI);
    eval 'sub IPMI_CC_SOFT_OVERTEMP () {0x5;}' unless defined(&IPMI_CC_SOFT_OVERTEMP);
    ...
    eval 'sub IPMI_ADS_CHASSIS () {0x80;}' unless defined(&IPMI_ADS_CHASSIS);
    eval 'sub IPMI_ADS_BRIDGE () {0x40;}' unless defined(&IPMI_ADS_BRIDGE);
    eval 'sub IPMI_ADS_EVENT_GEN () {0x20;}' unless defined(&IPMI_ADS_EVENT_GEN);
    eval 'sub IPMI_ADS_EVENT_RCV () {0x10;}' unless defined(&IPMI_ADS_EVENT_RCV);
    eval 'sub IPMI_ADS_FRU_INV () {0x8;}' unless defined(&IPMI_ADS_FRU_INV);
    eval 'sub IPMI_ADS_SEL () {0x4;}' unless defined(&IPMI_ADS_SEL);
    eval 'sub IPMI_ADS_SDR () {0x2;}' unless defined(&IPMI_ADS_SDR);
    eval 'sub IPMI_ADS_SENSOR () {0x1;}' unless defined(&IPMI_ADS_SENSOR);
    ...
    eval 'sub IPMI_SET_WD_ACTION_NONE () {0x;}' unless defined(&IPMI_SET_WD_ACTION_NONE);
    eval 'sub IPMI_SET_WD_ACTION_RESET () {0x1;}' unless defined(&IPMI_SET_WD_ACTION_RESET);
    eval 'sub IPMI_SET_WD_ACTION_POWER_DOWN () {0x2;}' unless defined(&IPMI_SET_WD_ACTION_POWER_DOWN);
    eval 'sub IPMI_SET_WD_ACTION_POWER_CYCLE () {0x3;}' unless defined(&IPMI_SET_WD_ACTION_POWER_CYCLE);
    eval 'sub IPMI_SET_WD_PREACTION_NONE () {(0x << 4);}' unless defined(&IPMI_SET_WD_PREACTION_NONE);
    eval 'sub IPMI_SET_WD_PREACTION_SMI () {(0x1 << 4);}' unless defined(&IPMI_SET_WD_PREACTION_SMI);
    eval 'sub IPMI_SET_WD_PREACTION_NMI () {(0x2 << 4);}' unless defined(&IPMI_SET_WD_PREACTION_NMI);
    eval 'sub IPMI_SET_WD_PREACTION_MI () {(0x3 << 4);}' unless defined(&IPMI_SET_WD_PREACTION_MI);
