...
unless(defined(&_SYS_CONSIO_H_)) {
    ...
    eval 'sub CONS_CHARCURSOR_COLORS () {(1<< 26);}' unless defined(&CONS_CHARCURSOR_COLORS);
    eval 'sub CONS_MOUSECURSOR_COLORS () {(1<< 27);}' unless defined(&CONS_MOUSECURSOR_COLORS);
    eval 'sub CONS_DEFAULT_CURSOR () {(1<< 28);}' unless defined(&CONS_DEFAULT_CURSOR);
    eval 'sub CONS_SHAPEONLY_CURSOR () {(1<< 29);}' unless defined(&CONS_SHAPEONLY_CURSOR);
    ...
    eval 'sub PIO_VFONT_DEFAULT () { &_IO(ord(\'c\'), 72);}' unless defined(&PIO_VFONT_DEFAULT);
