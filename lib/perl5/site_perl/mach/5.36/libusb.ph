...
unless(defined(&__LIBUSB_H__)) {
    ...
    eval 'sub LIBUSB_API_VERSION () {0x1000102;}' unless defined(&LIBUSB_API_VERSION);
    ...
    eval("sub LIBUSB_CLASS_PHYSICAL () { 5; }") unless defined(&LIBUSB_CLASS_PHYSICAL);
    ...
    eval 'sub LIBUSB_BT_USB_2_0_EXTENSION_SIZE () {7;}' unless defined(&LIBUSB_BT_USB_2_0_EXTENSION_SIZE);
    eval 'sub LIBUSB_BT_SS_USB_DEVICE_CAPABILITY_SIZE () {10;}' unless defined(&LIBUSB_BT_SS_USB_DEVICE_CAPABILITY_SIZE);
    eval 'sub LIBUSB_BT_CONTAINER_ID_SIZE () {20;}' unless defined(&LIBUSB_BT_CONTAINER_ID_SIZE);
    ...
    eval("sub LIBUSB_REQUEST_SET_SEL () { 0x30; }") unless defined(&LIBUSB_REQUEST_SET_SEL);
    eval("sub LIBUSB_REQUEST_SET_ISOCH_DELAY () { 0x31; }") unless defined(&LIBUSB_REQUEST_SET_ISOCH_DELAY);
    ...
    eval("sub LIBUSB_BT_WIRELESS_USB_DEVICE_CAPABILITY () { 1; }") unless defined(&LIBUSB_BT_WIRELESS_USB_DEVICE_CAPABILITY);
    eval("sub LIBUSB_BT_USB_2_0_EXTENSION () { 2; }") unless defined(&LIBUSB_BT_USB_2_0_EXTENSION);
    eval("sub LIBUSB_BT_SS_USB_DEVICE_CAPABILITY () { 3; }") unless defined(&LIBUSB_BT_SS_USB_DEVICE_CAPABILITY);
    eval("sub LIBUSB_BT_CONTAINER_ID () { 4; }") unless defined(&LIBUSB_BT_CONTAINER_ID);
    eval("sub LIBUSB_CAP_HAS_CAPABILITY () { 0; }") unless defined(&LIBUSB_CAP_HAS_CAPABILITY);
    eval("sub LIBUSB_CAP_HAS_HOTPLUG () { 1; }") unless defined(&LIBUSB_CAP_HAS_HOTPLUG);
    eval("sub LIBUSB_CAP_HAS_HID_ACCESS () { 2; }") unless defined(&LIBUSB_CAP_HAS_HID_ACCESS);
    eval("sub LIBUSB_CAP_SUPPORTS_DETACH_KERNEL_DRIVER () { 3; }") unless defined(&LIBUSB_CAP_SUPPORTS_DETACH_KERNEL_DRIVER);
    ...
    eval 'sub LIBUSB_HOTPLUG_MATCH_ANY () {-1;}' unless defined(&LIBUSB_HOTPLUG_MATCH_ANY);
    eval("sub LIBUSB_HOTPLUG_NO_FLAGS () { 0; }") unless defined(&LIBUSB_HOTPLUG_NO_FLAGS);
    eval("sub LIBUSB_HOTPLUG_ENUMERATE () { 1<<0; }") unless defined(&LIBUSB_HOTPLUG_ENUMERATE);
    eval("sub LIBUSB_HOTPLUG_EVENT_DEVICE_ARRIVED () { 1; }") unless defined(&LIBUSB_HOTPLUG_EVENT_DEVICE_ARRIVED);
    eval("sub LIBUSB_HOTPLUG_EVENT_DEVICE_LEFT () { 2; }") unless defined(&LIBUSB_HOTPLUG_EVENT_DEVICE_LEFT);
    eval("sub LIBUSB_OPTION_LOG_LEVEL () { 0; }") unless defined(&LIBUSB_OPTION_LOG_LEVEL);
    eval("sub LIBUSB_OPTION_USE_USBDK () { 1; }") unless defined(&LIBUSB_OPTION_USE_USBDK);
    eval("sub LIBUSB_OPTION_NO_DEVICE_DISCOVERY () { 2; }") unless defined(&LIBUSB_OPTION_NO_DEVICE_DISCOVERY);
    eval("sub LIBUSB_OPTION_WEAK_AUTHORITY () { 2; }") unless defined(&LIBUSB_OPTION_WEAK_AUTHORITY);
    eval("sub LIBUSB_OPTION_MAX () { 3; }") unless defined(&LIBUSB_OPTION_MAX);
